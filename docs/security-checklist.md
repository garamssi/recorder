...
| 7 | 로그에 사용자 데이터/프레임 미출력 + release 로그 제거 | ✅ | Log 호출은 손상 임시 파일 경고 1건뿐이며 파일명만 기록. release는 proguard `-assumenosideeffects`로 android.util.Log 전부 제거. 캡처 프레임·사용자 데이터 로깅 없음 |
